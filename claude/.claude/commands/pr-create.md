...
- コミット履歴を網羅的に記載するのではなく、**レビュアーが理解すべき大きな変更の概要**を最低限記載する
- 詳細な実装手順やPhase別のリストは避け、「何を」「なぜ」変更したかを2-3項目程度で簡潔にまとめる
- レビュアーが5分以内に全体像を把握できる粒度を目指す
- テンプレートの項目に沿って、冗長にならないよう記載する
